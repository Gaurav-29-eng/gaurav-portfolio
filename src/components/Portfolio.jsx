      ...
      <motion.section id="projects" className="px-10 mt-32 space-y-10 max-w-6xl mx-auto"
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="p-6 bg-[#0f172a] rounded-xl">
            ...
            <p className="text-gray-400">Real-time bidding system.</p>
            <div className="flex gap-4 mt-4">
              <span className="px-4 py-2 border border-gray-600 rounded">GitHub</span>
              <span className="px-4 py-2 bg-gray-700 rounded">Coming Soon</span>
            </div>
          </div>
