      ...
      >
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-6 md:gap-8 px-4 md:px-0 w-full">
          ...
          >
            ...
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-violet-500/20 via-purple-500/20 to-violet-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-0 pointer-events-none" />
