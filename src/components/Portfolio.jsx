  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex flex-row md:grid md:grid-cols-2 gap-4 md:gap-8 overflow-x-auto md:overflow-visible snap-x snap-mandatory md:snap-none scrollbar-hide px-4 md:px-0 pb-4 md:pb-0 w-full box-border">
          {/* IPL */}
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
